...
const phenolistTableCols = {'FINNGEN': [{
    ...
    Cell: props => (<a href={"/pheno/" + props.original.phenocode} target="_blank" rel="noreferrer">{props.value}</a>),
    minWidth: 300
}, {
    ...
    accessor: 'atc',
    Cell: props => (<a href={"https://www.whocc.no/atc_ddd_index/?code=" + props.value} target="_blank" rel="noreferrer">{props.value}</a>),
    minWidth: 200
},{
...
const regionTableCols = [{
    Header: () => (<span title="phenotype" style={{textDecoration: 'underline'}}>phenotype</span>),
    accessor: 'phenocode',
    Cell: props => (<a href={"/pheno/" + props.value} target="_blank" rel="noreferrer">{props.value}</a>),
    ...
    accessor: 'start',
    Cell: props => (<a href={"/region/" + props.original.phenocode + "/" + props.original.chr + ":" + props.original.start + "-" + props.original.end} target="_blank" rel="noreferrer">{props.original.chr + ':' + props.original.start + '-' + props.original.end}</a>),
    width: Math.min(270, 270/maxTableWidth*window.innerWidth),
...
const lofTableCols = [{
    Header: () => (<span title="phenotype" style={{textDecoration: 'underline'}}>phenotype</span>),
    accessor: 'phenostring',
    Cell: props => (<a href={"/pheno/" + props.original.pheno} target="_blank" rel="noreferrer">{props.value}</a>),
    minWidth: 400,
}, {
    Header: () => (<span title="gene" style={{textDecoration: 'underline'}}>gene</span>),
    accessor: 'gene',
    Cell: props => (<a href={"/gene/" + props.value} target="_blank" rel="noreferrer">{props.value}</a>),
    minWidth: 80
}, {
...
const chipTableCols = [{
    ...
    Cell: props => (<a href={"/pheno/" + props.original.pheno} target="_blank" rel="noreferrer">{props.value == 'NA' ? props.original.pheno : props.value}</a>),
    ...
    Cell: props => (
	    <a href={"/variant/" + props.value.replace(/:/g, '-')} target="_blank" rel="noreferrer">{props.value}</a>
    ),
    ...
    Cell: props => props.value == 'NA' ? props.value : (
	    <a href={"/variant/" + props.original.variant.replace(/:/g, '-')} target="_blank" rel="noreferrer">{props.value}</a>
    )
}, {
    ...
    Cell: props => (
	props.value == 'NA' ? props.value : <a href={"/gene/" + props.value} target="_blank" rel="noreferrer">{props.value}</a>
    )
}, {
    Header: () => (<span title="allele frequency" style={{textDecoration: 'underline'}}>af</span>),
    accessor: 'maf',
...
//     }
    ...
    filterMethod: null,
    Cell: props => {
	const grch37 = props.value && props.value != 'NA' ? (<a href={"https://gnomad.broadinstitute.org/variant/" + props.value.replace(/:/g, '-') + '-' + props.original.variant.split(':').slice(2).join('-')} rel="noreferrer" target="_blank">gn2</a>) : null
	const grch38 = props.original.gnomad3 == 1 ? (<a style={{float: 'right'}} href={"https://gnomad.broadinstitute.org/variant/" + props.original.variant.split(':').join('-') + '?dataset=gnomad_r3'} rel="noreferrer" target="_blank">gn3</a>) : null
	return <div>
	    {grch37}
	{grch38}
	</div>
...
const codingTableCols = [{
    ...
    Cell: props => (<a href={"/pheno/" + props.original.pheno} rel="noreferrer" target="_blank" rel="noreferrer">{props.value == 'NA' ? props.original.pheno : props.value}</a>),
    ...
    sortMethod: variantSorter,
    Cell: props => (
	    <a href={"/variant/" + props.value.replace(/:/g, '-')} rel="noreferrer" target="_blank" rel="noreferrer">{props.value}</a>
    ),
    width: Math.min(150, 150/maxTableWidth*window.innerWidth),
}, {
    Header: () => (<span title="rsid" style={{textDecoration: 'underline'}}>rsid</span>),
    ...
    width: Math.min(110, 110/maxTableWidth*window.innerWidth),
    Cell: props => (
	    <a href={"/variant/" + props.original.variant.replace(/:/g, '-')} rel="noreferrer" target="_blank">{props.value}</a>
    )
}, {
    Header: () => (<span title="most severe variant consequence from Variant Effect Predictor" style={{textDecoration: 'underline'}}>consequence</span>),
    accessor: 'most_severe',
    ...
    filterMethod: (filter, row) => row[filter.id].toLowerCase().startsWith(filter.value.toLowerCase()),
    Cell: props => (
	    <a href={"/gene/" + props.value} target="_blank" rel="noreferrer">{props.value}</a>
    )
}, {
	...
	return (
	    <div>
	    <span style={{paddingRight: '5px'}}><a href={`http://${window.release_prev.toLowerCase()}.finngen.fi/variant/${props.original.variant.replace(/:/g, '-')}`} target="_blank" rel="noreferrer">{window.release_prev}</a></span>
	    <span><a href={"https://gnomad.broadinstitute.org/variant/" + grch37} target="_blank" rel="noreferrer">gn</a></span>
	    </div>
	)
    }
}]
